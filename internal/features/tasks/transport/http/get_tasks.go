...
// @Tags 			tasks
// @Produce 		json
// @Param			limit query int false "Размер списка задач"
// @Param			offset query int false "Отступ от начала списка задач"
// @Param			user_id query int false "Список задач определенного пользователя"
// @Success 		200 {object} GetTasksResponse "Успешно полученный пользователь"
